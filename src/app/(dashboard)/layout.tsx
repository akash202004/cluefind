        ...
        <aside className="w-64 bg-card border-r-4 border-primary min-h-screen p-6">
          <nav className="space-y-2">
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">Profile</span>
            </Link>
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">Projects</span>
            </Link>
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">Endorsements</span>
            </Link>
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">AI Review</span>
            </Link>
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">Settings</span>
            </Link>
            ...
            >
              ...
              <span className="font-bold uppercase text-sm tracking-wide">Sign Out</span>
            </Link>
          </nav>
        </aside>
