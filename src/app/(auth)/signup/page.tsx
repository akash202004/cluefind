      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border-4 border-primary rounded-lg p-8 shadow-brutalist-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-section mb-2">Join DevSync</h1>
            <p className="text-subtitle">Create your developer portfolio</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            >
              <span className="font-black uppercase tracking-wide">Create Account</span>
            </button>
          </form>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/signin" className="font-bold uppercase tracking-wide text-accent hover:text-accent/80 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
